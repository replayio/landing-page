...
const ROUTES: Array<{ path: string; priority: number; changeFrequency: ChangeFrequency }> = [
  ...
  { path: '/engineers', priority: 0.8, changeFrequency: 'monthly' },
  { path: '/vibe-coders', priority: 0.8, changeFrequency: 'monthly' },
  { path: '/precog', priority: 0.8, changeFrequency: 'monthly' },
  { path: '/partner', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/builder', priority: 0.7, changeFrequency: 'monthly' },
