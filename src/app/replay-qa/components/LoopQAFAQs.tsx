...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    linkBefore:
      "Absolutely. If you've built a software factory, a vibecoding platform, or want to include Replay QA in your software development life cycle, ",
    linkText: "let's talk",
    a: '.'
  },
  {
  ...
  },
  {
    ...
    linkBefore: "For casual use, it is completely free. If you'd like to use Replay QA at scale, ",
    linkText: "let's talk",
    a: '.'
  },
  {
  ...
  },
  {
    ...
    a: 'Head to qa.replay.io, drop in a URL, and Replay QA gets to work. No setup, no credit card required to try it.'
  }
]
