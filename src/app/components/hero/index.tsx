            ...
            <div className="flex w-full min-w-0 flex-col items-center justify-center">
              ...
              >
                ...
                <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed tracking-tight text-slate-700 sm:text-lg">
                  Add the link to a Github repo for continuous testing, or drop in a URL for a web
                  app for on-demand testing. Replay QA explores your app, records every session,
                  finds real bugs, and gives your coding agent the root cause and fix.
                </p>
                <div className="mt-10">
                  <HeroUrlInput />
                </div>
