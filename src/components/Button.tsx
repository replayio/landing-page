...
type ButtonProps = (
  ...
  ) & { size?: keyof typeof sizeStyles; as?: 'button' | 'a' }
...
export function ClipboardButton({
  ...
  return (
    <Button onClick={handleCopy} {...rest}>
      <span className="relative flex w-full items-center justify-between space-x-2">
        <span
          className={clsx(
            'absolute left-1/2 top-1/2 flex w-full -translate-x-1/2 -translate-y-1/2 items-center justify-center gap-2',
