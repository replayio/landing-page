    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-gray-600">
          {feature.description} <span className="font-medium text-accent">{feature.highlight}</span>
        </p>
      </div>
  ...
  return (
    ...
    >
      <Container className="relative">
        ...
        <div className="mt-10 flex flex-col-reverse gap-6 lg:flex-row">
          ...
          <div className="flex flex-col lg:max-w-sm lg:flex-shrink-0">
            ...
            <div className="lg:hidden">
              <div
                className={`group flex w-full items-center gap-4 rounded-lg border-2 p-4 text-left transition-all ${'border-accent bg-white shadow-sm'}`}
              >
                {/* Previous button */}
                <button
                  type="button"
                  onClick={handlePrev}
                  className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-gray-200 bg-white text-accent shadow-md transition-transform active:scale-95"
