    ...
    <Section className={s.section}>
      <Container size="sm" className={s.container}>
        ...
        <div className={s.content}>
          <p>
            Welcome to Replay. Please read on to learn the rules and
          ...
          <p>
            ...
            and RECORD REPLAY INC. (“Replay,” “we” and “us”). Your use of the
            ...
            information about future changes to these Terms, automatic renewals,
        ...
        <div className={s.content}>
          <p>
            ...
            on our site located at replay.io, send you an email, and/or notify
        ...
        <div className={s.content}>
          <p>
            Replay takes the privacy of its users very seriously. For the
            current Replay Privacy Policy, please{' '}
        ...
        <div className={s.content}>
          <p>
            ...
            user name (“Replay User ID”), and provide us with certain
            ...
            information about yourself. You may not select as your Replay User
            ...
            privacy settings on your Third Party Account. You represent and
            ...
            permission to use the Services and have gotten your parent or
            guardian to agree to these Terms on your behalf). If you’re agreeing
            to these Terms on behalf of an organization or entity, you represent
            and warrant that you are authorized to agree to these Terms on that
            organization’s or entity’s behalf and bind them to these Terms (in
            which case, the references to “you” and “your” in these Terms,
            except for in this sentence, refer to that organization or entity).
            <br />
            <br />
            You will only use the Services for your own internal, non-commercial
            ...
            <br />
            <br />
            You will not share your Replay User ID, account or password with
            anyone, and you must protect the security of your Replay User ID,
            account, password and any other access tools or credentials. You’re
            responsible for any activity associated with your Replay User ID and
            account.
          </p>
        </div>
        ...
        <div className={s.content}>
          <p>
            ...
            Services, including messages that Replay sends you (for example, via
        ...
        <div className={s.content}>
          ...
          <ul>
            <li>
              ...
              other rights of anyone else (including Replay);
            </li>
            <li>
              ...
              not reasonably intended by Replay;
            </li>
            <li>
            ...
            <li>
              jeopardizes the security of your Replay User ID, account or anyone
        ...
        <div className={s.content}>
          <p>
            ...
            written permission from us. You understand that Replay owns the
        ...
        <Heading as="h2">
          ...
          any licenses to Replay or to other users
        </Heading>
        ...
        <div className={s.content}>
          <p>
            ...
            applicable laws, rules and regulations. You agree that you will not
            post, upload, share, store, or otherwise provide through the
            Services any User Submissions that: (i) infringe any third party's
            copyrights or other rights (e.g., trademark, privacy rights, etc.);
            (ii) contain sexually explicit content or pornography; (iii) contain
            hateful, defamatory, or discriminatory content or incite hatred
            against any individual or group; (iv) exploit minors; (v) depict
            unlawful acts or extreme violence; (vi) depict animal cruelty or
            extreme violence towards animals; (vii) promote fraudulent schemes,
        ...
        <div className={s.content}>
          <p>
            ...
            subject to our <Link href="/privacy-policy">Privacy Policy</Link> to
            the extent they relate to User Submissions that are also your
            personally-identifiable information.
            <br />
            <br />
            For all User Submissions, you hereby grant Replay a license to
            translate, modify (for technical purposes, for example, making sure
            your content is viewable on a mobile device as well as a computer)
            ...
            described in more detail below. This is a license only – your
            ownership in User Submissions is not affected.
            <br />
            <br />
            If you store a User Submission in your own personal Replay account,
            in a manner that is not viewable by any other user except you (a
            “Personal User Submission”), you grant Replay the license above, as
            ...
            <br />
            <br />
            If you share a User Submission in a manner that only certain
            ...
            grant Replay the licenses above, as well as a license to display,
            perform, and distribute your Limited Audience User Submission for
            the sole purpose of making that Limited Audience User Submission
            ...
            requests relating to the Services (each of the foregoing, a “Public
            User Submission”), then you grant Replay the licenses above, as well
            ...
            accessible to all Replay users and providing the Services necessary
            ...
            Services and/or otherwise in connection with Replay's business.
            Also, you grant all other users of the Services a license to access
            that Public User Submission, and to use and exercise all rights in
            ...
            delete your Replay account, we will stop displaying your User
            ...
            content from Replay's records, and that your User Submissions may
            ...
            identify the Content you are authorized to redistribute and the ways
            you may redistribute it, usually by providing a “share” button on or
            near the Content. If you share information from the Services with
            others through your Third Party Accounts, such as your social
            networks, you authorize Replay to share that information with the
            applicable Third Party Account provider. Please review the policies
            of any Third Party Account providers you share information with or
            through for additional information about how they may use your
            information. If you redistribute Content, you must be able to edit
            or delete any Content you redistribute, and you must edit or delete
            it promptly upon our request.
            <br />
            <br />
            Finally, you understand and agree that Replay, in performing the
        ...
        <div className={s.content}>
          <p>
            ...
            <br />
            <br />
            <strong>Procedure for Reporting Copyright Infringements.</strong> If
            you believe that material or content residing on or accessible
            through the Services infringes your copyright (or the copyright of
            someone whom you are authorized to act on behalf of), please send a
            notice of copyright infringement containing the following
            information to Replay's Designated Agent to Receive Notification of
            Claimed Infringement (our “Designated Agent,” whose contact details
            are listed below):
          </p>
          <ul>
            <li>
          ...
          <p>
            ...
            pursuant to the law, the content provider may send us a
          ...
          <ul>
            ...
            <li>
              ...
              the material was removed or disabled as a resolt of mistake or
            ...
            <li>
              ...
              located, or, if the content provider's address is located outside
              the United States, for any judicial district in which Company is
        ...
        <div className={s.content}>
          <p>
            ...
            services that are not owned or controlled by Replay. When you access
            third-party websites or use third-party services, you accept that
            there are risks in doing so, and that Replay is not responsible for
            such risks. Replay has no control over, and assumes no
            ...
            addition, Replay will not and cannot monitor, verify, censor or edit
            ...
            that you visit or utilize. By using the Services, you release and
            ...
            third parties. You agree that Replay shall not be responsible or
            liable for any loss or damage of any sort incurred as the result of
            any such dealings. If there is a dispute between participants on
            this site or Services, or between users and any third party, you
            agree that Replay is under no obligation to become involved. In the
            event that you have a dispute with one or more other users, you
            release Replay, its directors, officers, employees, agents, and
        ...
        <div className={s.content}>
          ...
          <ul>
            <li>
              ...
              Please see our Paid Services page for a description of the current
              Paid Services. Please note that any payment terms presented to you
              in the process of using or signing up for a Paid Service are
            ...
            <li>
              ...
              Stripe, Inc. as our Payment Processor. You can access Stripe’s
              Terms of Service at{' '}
            ...
            <li>
              ...
              pay all amounts due on your Billing Account upon demand. Recurring
              Billing. Some of the Paid Services may consist of an initial
              period, for which there is a one-time charge, followed by
              ...
              TO TERMINATE YOUR AUTHORIZATION OR CHANGE YOUR PAYMENT METHOD, GO
              TO ACCOUNT SETTINGS.
            </li>
            <li>
              ...
              BILLING ACCOUNT CURRENT, COMPLETE AND ACCURATE (SUCH AS A CHANGE
              IN BILLING ADDRESS, CREDIT CARD NUMBER, OR CREDIT CARD EXPIRATION
              DATE), AND YOU MUST PROMPTLY NOTIFY US OR OUR PAYMENT PROCESSOR IF
              ...
              <Link href="https://app.replay.io/?settings">
                ACCOUNT SETTINGS
              </Link>
            ...
            <li>
              ...
              amount of state sales taxes), you have the right to receive, and
              we shall provide, notice of the amount to be charged and the date
              ...
              incurred and submit them as one or more aggregate charges during
              or at the end of each billing cycle.
            </li>
            <li>
              <strong>Auto-Renewal for Paid Services.</strong> Unless you opt
              out of auto-renewal, which can be done through your{' '}
              <Link href="https://app.replay.io/?settings">
                account settings
              </Link>
              ...
              or terminate your REPLAY account before the end of the recurring
              ...
              provided in these terms, REPLAY will not refund any fees that you
              have already paid.
            </li>
            <li>
              <strong>Reaffirmation of Authorization.</strong> Your
              non-termination or continued use of a Paid Service reaffirms that
              we are authorized to charge your Payment Method for that Paid
              Service. We may submit those charges for payment and you will be
              responsible for such charges. This does not waive our right to
              seek payment directly from you. Your charges may be payable in
        ...
        <div className={s.content}>
          <p>
            ...
            <Link href="mailto:support@replay.io">support@replay.io</Link>;
            please refer to our{' '}
            <Link href="/privacy-policy">Privacy Policy</Link> as well as the
            licenses above, to understand how we treat information you provide
            to us after you have stopped using our Services.
            <br />
            <br />
            Replay is also free to terminate (or suspend access to) your use of
            the Services or your account for any reason in our discretion,
            including your breach of these Terms. Replay has the sole right to
            ...
            account (to the extent allowed by law and these Terms), but we may
            not do so if we determine it would be impractical, illegal, not in
            the interest of someone’s safety or security, or otherwise harmful
            to the rights or property of Replay.
            <br />
            <br />
            If you have deleted your account by mistake, contact us immediately
            at <Link href="mailto:support@replay.io">support@replay.io</Link> –
        ...
        <div className={s.content}>
          <p>
            <strong>Warranty Disclaimer.</strong> Replay and its licensors,
            suppliers, partners, parent, subsidiaries or affiliated entities,
            and each of their respective officers, directors, members,
            employees, consultants, contract employees, representatives and
            agents, and each of their respective successors and assigns (Replay
            and all such parties together, the “Replay Parties”) make no
            ...
            through the Services, and the Replay Parties will not be responsible
            or liable for the accuracy, copyright compliance, legality, or
            decency of material contained in or accessed through the Services or
            any claims, actions, suits procedures, costs, expenses, damages or
            liabilities arising out of use of, or in any way related to your
            participation in, the Services. The Replay Parties make no
            ...
            PROVIDED BY REPLAY (AND ITS LICENSORS AND SUPPLIERS) ON AN “AS-IS”
            ...
            LIABILITY, OR OTHERWISE) SHALL ANY OF THE REPLAY PARTIES BE LIABLE
            ...
            DAMAGES FOR LOST PROFITS, BUSINESS INTERRUPTION, LOSS OF DATA, LOSS
            OF GOODWILL, WORK STOPPAGE, ACCURACY OF RESULTS, OR COMPUTER FAILURE
            OR MALFUNCTION, (B) ANY SUBSTITUTE GOODS, SERVICES OR TECHNOLOGY,
            (C) ANY AMOUNT, IN THE AGGREGATE, IN EXCESS OF THE GREATER OF (I)
            ONE-HUNDRED ($100) DOLLARS OR (II) THE AMOUNTS PAID AND/OR PAYABLE
            BY YOU TO REPLAY IN CONNECTION WITH THE SERVICES IN THE TWELVE (12)
            MONTH PERIOD PRECEDING THIS APPLICABLE CLAIM OR (D) ANY MATTER
            ...
            <br />
            <br />
            <strong>Indemnity.</strong> You agree to indemnify and hold the
            Replay Parties harmless from and against any and all claims,
            ...
            indemnification obligations hereunder). Assignment. You may not
            assign, delegate or transfer these Terms or your rights or
            obligations hereunder, or your Services account, in any way (by
            operation of law or otherwise) without Replay's prior written
            ...
            law, and the laws of the State of California, without regard to the
            ...
            certain disputes and claims with Replay and limits the manner in
            which you can seek relief from Replay. Both you and Replay
            acknowledge and agree that for the purposes of any dispute arising
            out of or relating to the subject matter of these Terms, Replay's
          ...
          <ul>
            <li>
              Arbitration Rules; Applicability of Arbitration Agreement. The
              parties shall use their best efforts to settle any dispute, claim,
              question, or disagreement arising out of or relating to the
              ...
              Santa Clara County, California. The arbitration will proceed in
            ...
            <li>
              ...
              arbitration fees. Replay will pay all arbitration fees for claims
              less than seventy-five thousand ($75,000) dollars. Replay will not
              seek its attorneys’ fees and costs in arbitration unless the
              arbitrator determines that your claim is frivolous.
            </li>
            <li>
              Small Claims Court; Infringement. Either you or Replay may assert
              claims, if they qualify, in small claims court in Santa Clara
              County, California or any United States county where you live or
              work. Furthermore, notwithstanding the foregoing obligation to
            ...
            <li>
              Waiver of Jury Trial. YOU AND REPLAY WAIVE ANY CONSTITUTIONAL AND
              STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT OF A
              JUDGE OR JURY. You and Replay are instead choosing to have claims
              and disputes resolved by arbitration. Arbitration procedures are
              ...
              court. In any litigation between you and Replay over whether to
              vacate or enforce an arbitration award, YOU AND REPLAY WAIVE ALL
            ...
            <li>
              ...
              OR USER. If however, this waiver of class or consolidated actions
              is deemed invalid or unenforceable, neither you nor Replay is
            ...
            <li>
              ...
              permits either you or Replay to litigate any dispute arising out
              of or relating to the subject matter of these Terms in court, then
              the foregoing arbitration agreement will not apply to either
              party, and both you and Replay agree that any judicial proceeding
              (other than small claims actions) will be brought in the state or
              federal courts located in, respectively, Santa Clara County,
          ...
          <p>
            ...
            with the Services, provided that the Replay may, in its sole
            discretion, do any of the foregoing on your behalf or for itself as
            it sees fit. The failure of either you or us to exercise, in any
            way, any right herein shall not be deemed a waiver of any further
            rights hereunder. If any provision of these Terms are found to be
            ...
            and Replay agree that these Terms are the complete and exclusive
            statement of the mutual understanding between you and Replay, and
            ...
            you are not an employee, agent, partner, or joint venture of Replay,
            and you do not have any authority of any kind to bind Replay in any
            respect whatsoever.
            <br />
            <br />
            Except as expressly set forth in the section above regarding the
            arbitration agreement, you and Replay agree there are no third-party
